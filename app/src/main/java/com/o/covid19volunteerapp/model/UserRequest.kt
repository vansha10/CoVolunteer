 ...
 **/
data class UserRequest(var requestText: String, var locality: Locality, var requestId: String, var responses: List<Response>) {
    constructor() : this ("", Locality(), "", List<Response>(0) { Response() })
